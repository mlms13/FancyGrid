...
var ArrayVsMapCache = function() { };
ArrayVsMapCache.__name__ = ["ArrayVsMapCache"];
ArrayVsMapCache.main = function() {
	var tests = thx_Ints.range(100000).map(function(v) {
		return { index : v, value : "" + v * v};
	});
	ArrayVsMapCache.testSetCache(tests);
	ArrayVsMapCache.testGetCacheSmall(tests);
	ArrayVsMapCache.testGetCache(tests);
};
ArrayVsMapCache.testSetCache = function(tests) {
...
ArrayVsMapCache.testGetCache = function(tests) {
	var suite = new thx_benchmark_speed_Suite(10,2500);
	var cache1 = [];
	var _g = 0;
	while(_g < tests.length) {
	...
	var cache2 = new haxe_ds_IntMap();
	var _g1 = 0;
	while(_g1 < tests.length) {
		var t1 = tests[_g1];
		++_g1;
		cache2.h[t1.index] = t1.value;
	}
	suite.addCase("get array cache",function(__counter__) {
		...
		while(--__counter__ >= 0.0) {
			var _g2 = 1;
			while(_g2 < 1000000) buf.push(cache1[_g2++]);
		}
		__timer__.stop();
		return __timer__.get_elapsed();
	});
	suite.addCase("get map cache",function(__counter__1) {
		...
		while(--__counter__1 >= 0.0) {
			var _g3 = 1;
			while(_g3 < 1000000) buf1.push(cache2.h[_g3++]);
		}
		__timer__1.stop();
		return __timer__1.get_elapsed();
	});
...
ArrayVsMapCache.testGetCacheSmall = function(tests) {
	var suite = new thx_benchmark_speed_Suite(10,2500);
	var cache1 = [];
	var _g = 0;
	while(_g < tests.length) {
	...
	suite.addCase("get array cache",function(__counter__) {
		...
		while(--__counter__ >= 0.0) {
			var _g2 = 1;
			while(_g2 < 1000) buf.push(cache1[_g2++]);
		}
		__timer__.stop();
		return __timer__.get_elapsed();
	});
	suite.addCase("get map cache",function(__counter__1) {
		...
		while(--__counter__1 >= 0.0) {
			var _g3 = 1;
			while(_g3 < 1000) buf1.push(cache2.h[_g3++]);
		}
		__timer__1.stop();
		return __timer__1.get_elapsed();
	});
